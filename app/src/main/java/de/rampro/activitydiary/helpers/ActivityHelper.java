...
// TODO: do we need to keep track on the scheduled jobs, or is a waiting job with the same ID as a new one automatically canceled?
    ...
    public interface DataChangedListener{
         ...
         * => everything needs to be refreshed! 活动更新
         */
    ...
    public void showCurrentActivityNotification() {
        if(PreferenceManager
            ...
            PendingIntent pIntent = PendingIntent.getActivity(ActivityDiaryApplication.getAppContext(), (int) System.currentTimeMillis(), intent, PendingIntent.FLAG_MUTABLE);
